...
```shell
curl --request POST \
  --url <URL>/api/v2/dashboard/create_borrower/ \
...
`POST <URL>/api/v2/dashboard/create_borrower`
...
```shell
curl --request GET \
  --url <URL>/api/v2/parser/supported_banks \
  --header 'Content-Type: application/json' \
  --header 'access-id: your_access_id' \
  --header 'access-key: your_access_key'
```
...
`GET <URL>/api/v2/parser/supported_banks`
...
```json
{
  "data": {
    ...
    "errorTransactions": {
      "01/09/18": [
        {
          "balanceAmount": 22373.41,
          "date": "01/09/18",
          "depositAmount": 0,
          "isAutoDebit": false,
          "particular": "ADITYA RATHI-NETBANK",
          "reference": "73456",
          "type": "DEBIT",
          "withdrawalAmount": 8950
        },
        {
          "balanceAmount": 71373.41,
          "date": "01/09/18",
          "depositAmount": 49000,
          "isAutoDebit": false,
          "particular": "NEFT-LAXMI V",
          "reference": "",
          "type": "CREDIT",
          "withdrawalAmount": 0
        }
      ...
      "02/07/18": [
        {
          "balanceAmount": 270411.6,
          "date": "02/07/18",
          "depositAmount": 30000,
          "isAutoDebit": false,
          "particular": "BY CASH-AMEERJEET",
          "reference": "",
          "type": "CREDIT",
          "withdrawalAmount": 0
        },
        {
          "balanceAmount": 180774.6,
          "date": "02/07/18",
          "depositAmount": 0,
          "isAutoDebit": false,
          "particular": "EKI May",
          "reference": "",
          "type": "DEBIT",
          "withdrawalAmount": 89637
        },
        {
          "balanceAmount": 230774.6,
          "date": "02/07/18",
          "depositAmount": 50000,
          "isAutoDebit": false,
          "particular": "BY CASH-AMEER",
          "reference": "",
          "type": "CREDIT",
          "withdrawalAmount": 0
        },
        {
          "balanceAmount": 290774.6,
          "date": "02/07/18",
          "depositAmount": 60000,
          "isAutoDebit": false,
          "particular": "StCon",
...
<aside class="notice"> 
  Users should switch to a newer version v2!
</aside>
...
<aside class="notice"> 
  v2 supports parsing of statements that have multiple accounts in them. The response of v1 is wrapped in a account number key in v2.
</aside>

### HTTP Request

`POST <URL>/api/v2/parser/`
...
`POST <URL>/api/v2/parser/reanalyse/`
